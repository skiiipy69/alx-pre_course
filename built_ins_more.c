 ...
 */
int built_in_exit(data_of_program *data)
{
	int i;
...
/**
 * built_in_cd - change the current directory
 *
 * @data: struct for the program's data
 *
 * Return: 0 if sucess, or other .....
 */
int built_in_cd(data_of_program *data)
{
...
int built_in_help(data_of_program *data)
{
	int i;
